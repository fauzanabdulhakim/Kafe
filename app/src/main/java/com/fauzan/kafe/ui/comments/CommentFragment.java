...
import com.fauzan.kafe.Adapter.MyCommentAdapter;
import com.fauzan.kafe.Callback.CommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements CommentCallbackListener {
    ...
    AlertDialog dialog;
    CommentCallbackListener listener;
